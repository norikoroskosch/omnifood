...
<body>
  ...
  <section class="section-features js--section-features" id="get-food-fast">
    <div class="row">
    ...
    <div class="row js--wp-1">
      <div class="col span-1-of-4 box">
        <i class="fas fa-calendar-alt fa-2x icon-big"></i>
      ...
      <div class="col span-1-of-4 box">
        <i class="far fa-clock fa-2x icon-big"></i>
  ...
  <section class="section-meals">
    <ul class="meals-showcase clearfix">
      ...
      <li>
        <figure class="meal-photo">
          <img src="resources/img/2.jpg" alt="Simple italian pizza with cherry" />
        </figure>
      </li>
      <li>
        <figure class="meal-photo">
    ...
    <ul class="meals-showcase clearfix">
      ...
      <li>
        <figure class="meal-photo">
          <img src="resources/img/8.jpg" alt="Burger with cheddar and bacon" />
        </figure>
      </li>
    </ul>
  </section>
    ...
    <div class="row">
      <div class="col span-1-of-4 box">
        ...
        <div class="city-feature">
          ...
          <i class="fas fa-glass-martini icon-small"></i>
    ...
    <div class="row">
      <div class="col span-1-of-3">
        <blockquote>
          ...
          <cite><img src="resources/img/customer-1.jpg">Albert Duncan</cite>
        </blockquote>
      </div>
    ...
    <div class="row">
        ...
        <div class="plan-box">
          ...
          <div>
            <ul>
              ...
              <li><i class="fas fa-check icon-small "></i>Access to newest creation</li>
      ...
      <div class="col span-1-of-3">
        <div class="plan-box">
          ...
          <div>
            <ul>
              <li><i class="fas fa-check icon-small "></i>1 meal 10 day/month</li>
              <li><i class="fas fa-check icon-small"></i>Order 24/7</li>
              <li><i class="fas fa-check icon-small"></i>Access to newest creation</li>
              <li><i class="fas fa-check icon-small"></i>Free delivery</li>
            </ul>
        ...
        <div class="plan-box">
          ...
          <div>
            <ul>
              ...
              <li><i class="fas fa-exclamation icon-small"></i></li>
              <li><i class="fas fa-check icon-small"></i>Free delivery</li>
            </ul>
          </div>
          <div>
      ...
      <form method="post" action="mailer.php" class="contact-form">
        ...
        <div class="row">
          ...
          if($_GET['success'] == 1) {
            ...
            Thank you! Your message has been send. </div>";
          }
          
          if($_GET['success'] == -1) {
            echo <div class=\"form-messages error\">
          Oops! Something went wrong. Please try agatin.</div>";}
          ?>
